...
import com.hzj.quicknews.weather.model.WeatherModel;
import com.hzj.quicknews.weather.model.WeatherModelImpl;
import com.hzj.quicknews.weather.view.WeatherView;
import com.hzj.quicknews.beans.WeatherBean;
import com.hzj.quicknews.utils.ToolsUtil;
import com.hzj.quicknews.weather.model.WeatherModel;
import com.hzj.quicknews.weather.model.WeatherModelImpl;
import com.hzj.quicknews.weather.view.WeatherView;
    ...
    public void loadWeatherData() {
        ...
        WeatherModelImpl.LoadLocationListener listener = new WeatherModelImpl.LoadLocationListener() {
            ...
            public void onFailure(String msg, Exception e) {
                ...
                mWeatherView.setCity("福州");
                mWeatherModel.loadWeatherData("福州", WeatherPresenterImpl.this);
            }
        };
        //获取定位信息
